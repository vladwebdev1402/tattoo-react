          ...
          <div className={st.dataInfoWrapper}>
            ...
            <div className={st.dataInfoContainer}>
              ...
              <div className={st.dataContainerValue}>
                {order.contactPerson.city}, {order.contactPerson.streetAndHouse}, кв.{' '}
                {order.contactPerson.flat}
              </div>
            </div>
            <div className={st.dataInfoContainer}>
              <div className={st.dataContainerHead}>Сумма заказа:</div>
              <div className={st.dataContainerValue}>{order.sum.toLocaleString('ru-RU')} ₽</div>
            </div>
          </div>
        </div>
        <div className={st.person}>
          ...
          <div className={st.dataInfoWrapper}>
            <div className={st.dataInfoContainer}>
              ...
              <div className={st.dataContainerValue}>{order.contactPerson.fullName}</div>
            </div>
            <div className={st.dataInfoContainer}>
              <div className={st.dataContainerHead}>Телефон</div>
              <div className={st.dataContainerValue}>{order.contactPerson.number}</div>
            </div>
            <div className={st.dataInfoContainer}>
              <div className={st.dataContainerHead}>Эл. почта</div>
              <div className={st.dataContainerValue}>{order.contactPerson.mail}</div>
            </div>
          </div>
        </div>
      </div>
